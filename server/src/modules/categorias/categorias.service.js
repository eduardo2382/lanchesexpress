...
exports.findAllCategorias = async (query) => {
...
exports.updateCategoria = async (id, body) => {
    ...
    let categoria = (await repository.findById(id))[0]
